...
import BackendTheme from "./components/BackendTheme/BackendTheme";
      ...
      <BrowserRouter>
        ...
        <Main>
          <Routes>
            ...
            <Route
              element={<UserPrivateRoute permission={"update-setting"} />}
            >
              <Route
                path="/admin/logo"
                exact
            ...
            >
              <Route
                path="/admin/backend-theme"
                exact
                element={<BackendTheme />}
              />
            </Route>
            <Route
              element={<UserPrivateRoute permission={"update-setting"} />}
            ...
            >
              <Route
                path="/admin/student-guardian-panel"
                exact
                element={<StudentGuardianPanel />}
              />
            </Route>
            <Route
              path="/admin/sessions"
